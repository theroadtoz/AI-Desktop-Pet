...
- Release ID: `record-live2d-motion-2026-07-14.2`
- Profile schema: `live2d-recorder-profile/v1`
- Take contract schema: `live2d-take-contract/v1`
- Package-content-digest: `sha256:0f7118797bbe7563efac6cb16eedacc419d61068a1e2c6ba9d1736389a395c39`
...
- 录制 `greet-small`：读 [greet-small-v1.md](references/profiles/greet-small-v1.md)；倒数显示 `开始` 后，按“中性、轻点头、抬回时闭口微笑、回到中性”的节奏表演。产物仍仅为 draft。
