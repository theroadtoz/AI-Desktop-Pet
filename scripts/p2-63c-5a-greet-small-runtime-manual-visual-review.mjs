...
const EXPECTED_BASENAME = "greet-small-20260714-114327-647.motion3.json";
const EXPECTED_SHA256 = "f456d88757ab7650631364f201fb43812332d903599ef4bc4f751d193ca87bfa";
const EXPECTED_BYTES = 40_675;
const EXPECTED_DURATION_SECONDS = 2.4;
const EXPECTED_DURATION_MS = 2_400;
const MOTION_DURATION_TOLERANCE_MS = 120;
const EXPECTED_FPS = 30;
const EXPECTED_CURVE_COUNT = 10;
const EXPECTED_SEGMENT_COUNT = 620;
const EXPECTED_POINT_COUNT = 630;
...
const CONTACT_RISK_WINDOWS = Object.freeze([
  { id: "1400-1830", startMs: 1_400, endMs: 1_830 },
  { id: "2100-2200", startMs: 2_100, endMs: 2_200 }
]);
